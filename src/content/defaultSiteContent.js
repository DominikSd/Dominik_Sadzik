    ...
    items: [
      {
        ...
        text: "Responsywna strona uslugowa z czytelna oferta, kartami terapii, sekcja szczegolow i szybkim kontaktem. Podglad prowadzi do wdrozonej realizacji.",
        status: "realizacja",
        tags: ["React", "Vite", "SEO", "strona uslugowa"],
        href: "https://iwona-sadzik.netlify.app/",
        linkLabel: "Otworz strone",
        screenshotUrl: "portfolio/neuronest-site.svg",
        mockupTone: "cyan",
      },
      {
        type: "Wizytowka/projekt graficzny",
        title: "Branding naturopatii",
        text: "Projekt wizytowki i identyfikacji wizualnej z naturalnym motywem, spokojna kolorystyka i czytelnym ukladem pod druk oraz prezentacje online.",
        status: "projekt koncepcyjny",
        tags: ["wizytowka", "branding", "grafika", "druk"],
        screenshotUrl: "portfolio/naturopathy-card.svg",
        mockupTone: "emerald",
      },
      {
        type: "Projekt demo",
        title: "Grafika promocyjna placowki",
        text: "Kolorowa grafika informacyjna pokazujaca, jak mozna polaczyc ikony, zdjecia i tekst w material dla lokalnej placowki lub kampanii.",
        status: "projekt koncepcyjny",
        tags: ["grafika", "ulotka", "layout", "informacje"],
        screenshotUrl: "portfolio/puchatek-poster.svg",
        mockupTone: "violet",
      },
      {
