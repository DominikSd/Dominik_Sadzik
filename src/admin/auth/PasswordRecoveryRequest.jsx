...
import { getAuthRecoveryUrl } from "./authRedirects.js";
...
export default function PasswordRecoveryRequest() {
  ...
  async function submit(event) {
    ...
    setMessage("Link resetu hasła został wysłany. Sprawdź swoją skrzynkę e-mail i kliknij go.");
  }
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      >
        {busy ? "Wysyłanie..." : "Wyślij link resetu"}
      </button>
    </form>
  );
}
