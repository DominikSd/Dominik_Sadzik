    ...
    <div className="space-y-5">
      ...
      <FormGrid>
        ...
        <Field label="Tekst przycisku email">
          <TextInput value={value.emailButtonLabel} onChange={(event) => update({ emailButtonLabel: event.target.value })} />
        </Field>
        <Field label="Tekst przycisku telefonu">
          <TextInput value={value.phoneButtonLabel} onChange={(event) => update({ phoneButtonLabel: event.target.value })} />
        </Field>
      </FormGrid>
    </div>
  );
